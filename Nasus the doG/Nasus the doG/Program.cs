            ...
            if ((useQ && farmActive) || (useQ2 && clearActive))
            {
                ...
                foreach (var minion in Minions)
                {
                    if (minion != null)
                    {
                        ...
                        var targetQDam = ObjectManager.Player.GetSpellDamage(minion, SpellSlot.Q);
                        ...
                        var targetQandAAdmg = Damage.GetAutoAttackDamage(ObjectManager.Player, minion) + ObjectManager.Player.GetSpellDamage(minion, SpellSlot.Q);
